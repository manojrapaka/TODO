...
import com.mr.todo.ui.*;
import com.mr.todo.gwt.client.*;
...
@Widgetset("com.mr.todo.gwt.ToDoWidgetSet")
@Theme("touchkit")
...
@PreserveOnRefresh
public class ToDoTouchKitUI extends UI {

    private final ToDoPersistToServerRpc serverRpc = new ToDoPersistToServerRpc() {
        @Override
